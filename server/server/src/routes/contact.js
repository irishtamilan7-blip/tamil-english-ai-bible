  ...
  if (apiKey && adminEmail) {
    ...
    try {
      ...
      await resend.emails.send({
        ...
        to: [adminEmail],
        subject: `[Tamil English AI Bible] ${subject || 'Contact'} — ${name}`,
      ...
      await resend.emails.send({
        from: 'BibleVoice <onboarding@resend.dev>',
        to: [email],
        subject: '[Tamil English AI Bible] We received your message',
        text: `Hi ${name},\n\nThank you for contacting Tamil English AI Bible. We've received your message and will get back to you soon.\n\nGod bless,\nTamil English AI Bible Team\n\n---\nYour message:\n${message}`,
      })
    } catch (err) {
